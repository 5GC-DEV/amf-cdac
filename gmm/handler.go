...
func HandleConfigurationUpdateComplete(ue *context.AmfUe,
	...
	//		import "github.com/5GC-DEV/openapi-cdac/Nudm_SubscriberDataManagement" client.Info
...
func HandleServiceRequest(ue *context.AmfUe, anType models.AccessType,
	...
	ue.GmmLog.Info("---ue current state: ", ue.State[anType].Current())
	scValid := ue.SecurityContextIsValid()
	ue.GmmLog.Info("---scvalid: ", scValid)
